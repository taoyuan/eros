...
var construct = exports.construct = function(/*parent, name, options*/) {
    ...
    var ErrorClass = scope[className] = function(msg, expl, fix) {
        if (!(this instanceof ErrorClass)) return new ErrorClass(msg, expl, fix);
        var attrs = {};
...
exports.notImplemented = function (message, data) {
    return exports.NotImplementedError({ message: message, data: data });
};

exports.BadGatewayError = construct(InternalError, 'BadGatewayError', { code: 502 });
exports.badGateway = function (message, data) {
    return exports.BadGatewayError({ message: message, data: data });
};
...
exports.serverTimeout = function (message, data) {
    return exports.ServerTimeoutError({ message: message, data: data });
};

exports.GatewayTimeoutError = construct(InternalError, 'GatewayTimeoutError', { code: 504 });
exports.gatewayTimeout = function (message, data) {
    return exports.GatewayTimeoutError({ message: message, data: data });
};

exports.BadImplementationError = construct(InternalError, 'BadImplementationError', { code: 505 });
exports.badImplementation = function (message, data) {
    var err = exports.BadImplementationError({ message: message, data: data });
